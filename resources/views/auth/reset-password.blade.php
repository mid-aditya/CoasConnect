<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Setel Password Baru</h1>
            <p class="text-gray-500 mt-2">Buat password yang kuat untuk akun Anda</p>
        </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="email" id="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" readonly
                    class="block w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-100 cursor-not-allowed">
            </div>
