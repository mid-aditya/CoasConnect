      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-20 pb-10 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-6 text-lg leading-relaxed text-sand-100/70 max-w-md">
            CoasConnect menghubungkan nelayan, koperasi, dan pasar dalam satu
            jaringan yang terbuka — informasi tangkapan, harga, dan logistik
            mengalir dari satu titik ke titik lain, tanpa perantara.
          </p>
          ...
          <dl className="mt-12 grid grid-cols-3 gap-6 max-w-sm">
            {[
              ['1.200+', 'anggota terhubung'],
              ['38', 'desa pesisir'],
              ['Rp 2,4 M', 'transaksi / bulan'],
            ].map(([value, label]) => (
              <div key={label}>
        ...
        <div className="relative">
          <div className="rounded-2xl bg-ink-900/70 ring-1 ring-white/10 p-6 shadow-2xl">
            ...
            <p className="mt-4 text-xs text-sand-100/45 leading-relaxed">
              Setiap titik adalah komunitas. Setiap garis adalah koneksi nyata
              antara nelayan, koperasi, dan pasar.
            </p>
          </div>
        </div>
      </div>
